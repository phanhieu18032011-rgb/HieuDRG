...
toggleButton.Image = "rbxassetid://94439769761633"
...
local Tabs = {
  information = Window:AddTab({Title = "thông tin", Icon = "rbxassetid://"}),
  Main = Window:AddTab({Title = "Farm", Icon = "rbxassetid://"}),
  Settings = Window:AddTab({Title = "Farm setting", Icon = "rbxassetid://"}),
  Melee = Window:AddTab({Title = "Auto Get Melee V2", Icon = "rbxassetid://"}),
  Quests = Window:AddTab({Title = "Items Farm", Icon = "rbxassetid://"}),
  SeaEvent = Window:AddTab({Title = "Sea Events", Icon = "rbxassetid://"}),
  Mirage = Window:AddTab({Title = "Mirage + RaceV4", Icon = "rbxassetid://"}),
  Drago = Window:AddTab({Title = "Drago Dojo", Icon = "rbxassetid://"}),
  Prehistoric = Window:AddTab({Title = "Prehistoric", Icon = "rbxassetid://"}),
  Raids = Window:AddTab({Title = "Tập kích", Icon = "rbxassetid://"}),
  Combat = Window:AddTab({Title = "Combat PVP", Icon = "rbxassetid://"}),
  Travel = Window:AddTab({Title = "Teleport", Icon = "rbxassetid://"}),
  Fruit = Window:AddTab({Title = "Trái ác quỷ", Icon = "rbxassetid://"}),
  Shop = Window:AddTab({Title = "Cửa hàng", Icon = "rbxassetid://"}),
  Misc = Window:AddTab({Title = "Khác", Icon = "rbxassetid://"})
}
...
Tabs.information:AddButton({
        ...
        Callback=function()
            setclipboard(tostring("https://discord.gg/eGJ9J9a2")) 
        end
})
Tabs.information:AddButton({
        Title="TikTok",
...
Tabs.Main:AddSection("Tab farm lever")
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "Update Cày Level 2650-2750", Default = false})
